...
;															    ;		
;																;
;					Assignment4 Additions              		   	;
;*Added 4 new items for the multi part object					;
;*Added the game-repl functions									;
;																;
;***************************************************************;
...
(defparameter *objects* '(whiskey bucket frog chain knife elastic_rubber_band wood candy_wrapper rock))

(defparameter *object-locations* '((whiskey living-room)
                                   (bucket living-room)
								   (elastic_rubber_band living-room) ;multi-part object
                                   (chain garden)
                                   (frog garden)
								   (wood garden) ;multi-part object 
								   (rock attic) ;multi-part object
								   (knife kitchen)
								   (candy_wrapper kitchen))) ;multi-part object
